      ...
      <Collapse in={isExpanded}>
        <Box mt={{ base: "4", lg: "4" }}>
          ...
          <Flex ml={{ base: "0", lg: "15rem" }} mt={{ base: "5rem", lg: "5rem" }}>
            <Button onClick={handleBackButtonClick} w={{ base: "100%", lg: "150px" }}color="#ffff" backgroundColor="#d7a022">
              Back
            </Button>
            <Button ml="1rem" w={{ base: "100%", lg: "150px" }} color="#ffff" backgroundColor="#d7a022">Pay</Button>
          </Flex>
        </Box>
      </Collapse>
    </Card>
